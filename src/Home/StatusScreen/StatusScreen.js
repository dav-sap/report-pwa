    ...
    render() {
        return (
            <div className="status-div">
                ...
                <div className="status-button odd-button"  style={{background: COLOR_MAP["WF"]}}
                        onClick={() => this.statusChosen("WF")} ><div className="text-div">WF</div><span id="WFH" style={this.state.chosenStatus === 'WF' ? this.spanStyle :{}}/></div>
